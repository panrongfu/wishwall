 ...
 */
public class EditPersonDetail extends BaseActivity
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.layout_change_detail_loacl:
				Intent local = new Intent(getApplicationContext(),ProvCityArea.class);
        ...
        ApiClient.updateUserInfo(
                ...
                uploadWx, uploadQq, new Callback<ResultDTO>() {
                    ...
                    public void onResponse(Call<ResultDTO> call, Response<ResultDTO> response) {
                        ...
                        if(body.getCode() == 200){
                            CustomToast.showMsg(EditPersonDetail.this,"保存成功");
                            progressDialog.dismiss();
                        }else {
                            CustomToast.showMsg(EditPersonDetail.this,body.getMessage());
                            progressDialog.dismiss();
                        }
                    }
    ...
    private void initPopupWindow() {
        ...
        popupwindow.setOnItemClickListener(new ImageSelectPopupWindow.OnItemClickListener() {
            ...
            public void fromPhoto() {
                Intent intent = new Intent(EditPersonDetail.this,OptionImgActivity.class);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                resuambleUploadSamples.setUpLoadFinishListener(new ResuambleUploadSamples.UpLoadFinishListener() {
                    ...
                    @Override
                    public void fail() {
                        CustomToast.showMsg(EditPersonDetail.this,"保存失败");
                        progressDialog.dismiss();
                    }
                });
