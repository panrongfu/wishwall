...
public class ProvCityArea extends BaseActivity
        ...
        ApiClient.findAllProv(new Callback<ProvCityAreaDTO>() {
            ...
            public void onResponse(Call<ProvCityAreaDTO> call, Response<ProvCityAreaDTO> response) {
				...
				if(body.getCode() == 200){
                    ...
                    ProvinceAdapter province_adapter = new ProvinceAdapter(ProvCityArea.this, provinceLists);
            ...
            ApiClient.findProvCity(proCode, new Callback<ProvCityAreaDTO>() {
                ...
                public void onResponse(Call<ProvCityAreaDTO> call, Response<ProvCityAreaDTO> response) {
                    ...
                    if(body.getCode() == 200){
                        ...
                        ProvinceAdapter province_adapter  = new ProvinceAdapter(ProvCityArea.this, citysLists);
			...
			ApiClient.findCityArea(cityCode, new Callback<ProvCityAreaDTO>() {
                ...
                public void onResponse(Call<ProvCityAreaDTO> call, Response<ProvCityAreaDTO> response) {
                    ...
                    if(body.getCode() == 200){
                        ...
                        ProvinceAdapter province_adapter  = new ProvinceAdapter(ProvCityArea.this, areaLists);
