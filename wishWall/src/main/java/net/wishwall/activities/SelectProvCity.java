 ...
 */
public class SelectProvCity extends BaseActivity  {
                    ...
                    ApiClient.getAllCity(new Callback<ProvCityAreaDTO>() {
                        ...
                        public void onResponse(Call<ProvCityAreaDTO> call, Response<ProvCityAreaDTO> response) {
                            ...
                            if(cityBody.getCode() == 200){
                                ...
                                expandableListViewAdapter = new ExpandableListViewAdapter(SelectProvCity.this,provinceLists,pCitysLists);
	...
	class ChildItemsClickListener implements OnChildClickListener {
		...
		public boolean onChildClick(ExpandableListView parent, View v,int groupPosition, int childPosition, long id) {
			...
			SelectProvCity.this.setResult(RESULT_OK, intentCity);
			SelectProvCity.this.finish();
			return true;
		}
	}
