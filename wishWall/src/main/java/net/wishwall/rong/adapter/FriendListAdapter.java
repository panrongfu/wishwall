...
import net.wishwall.rong.model.FriendSectionIndexer;
import net.wishwall.rong.utils.pinyin.PinyinFilterList;
import net.wishwall.rong.widget.PinnedHeaderAdapter;
