...
public class SearchFriendAdapter extends android.widget.BaseAdapter {
    ...
    private List<FriendLikeNameDTO.ResultBean> mResults;

    public SearchFriendAdapter(List<FriendLikeNameDTO.ResultBean> results, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // Resource res = new Resource(mResults.get(position).getPortrait());
        ...
        if(viewHolder != null) {
            ...
            viewHolder.mImageView.setDefaultDrawable(mContext.getResources().getDrawable(R.mipmap.de_default_portrait));
